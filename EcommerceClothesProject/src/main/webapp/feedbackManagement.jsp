...
<body>
	...
	<a href="<%=request.getContextPath()%>/Cfeedback.jsp" class="btn btn-success">Add New Feedback</a>
	</div>
	<br>
	...
	<td>
	<a href="edit?name=<c:out value='${feedback.feedback}'
	/>">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;
	<a href="delete?feedback=<c:out
